...
fci_tbl_06_01 <- function() {
  data.frame(
    ...
    .lower = c(0.263, 0.206, -0.212, 0.528),
    .estimate = c(0.375, 0.289, -0.086, 0.77),
    .upper = c(0.487, 0.372, 0.039, 1.12),
    .alpha = 0.05,
    .method = "norm")
}
...
fci_tbl_06_04 <- function() {
  data.frame(
    term = c("EY0", "EY1", "RD", "RR"),
    .lower = c(0.247, 0.192, -0.207, 0.52),
    .estimate = c(0.361, 0.276, -0.085, 0.765),
    .upper = c(0.476, 0.36, 0.037, 1.12),
    .alpha = 0.05,
    .method = "norm")
}
...
fci_tbl_06_07 <- function() {
  data.frame(
    term = c("EY0", "EY1", "RD", "RR"),
    .lower = c(0.249, 0.216, -0.188, 0.564),
    .estimate = c(0.360, 0.300, -0.061, 0.831),
    .upper = c(0.472, 0.384, 0.067, 1.23),
    .alpha = 0.05,
    .method = "norm")
}
...
fci_tbl_06_09 <- function() {
  data.frame(
    term = c("EY0", "EY1", "RD", "RR"),
    .lower = c(0.249, 0.220, -0.188, 0.565),
    .estimate = c(0.360, 0.300, -0.061, 0.834),
    .upper = c(0.471, 0.380, 0.069, 1.23),
    .alpha = 0.05,
    .method = "norm")
}
