...
that this package is **not for commercial use** as the functions are not designed
to be efficient or robust.  This package is a *learning tool*, not a *working tool*.
